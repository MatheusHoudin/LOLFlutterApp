...
class Database{
  ...
  void getChampions(){
    ...
    Champion anivia = Champion(
        ...
        rpPrice: 790,
        skins: [Skin(skinName: 'Anivia',skinNumber: 0),Skin(skinName: 'Team Spirit Anivia',skinNumber: 1,price: 520),Skin(skinName: 'Bird of Prey Anivia',skinNumber: 2,price: 520),
          Skin(skinName: 'Noxus Hunter Anivia',skinNumber: 3,price: 520),Skin(skinName: 'Hextech Anivia',skinNumber: 4,price: 750),Skin(skinName: 'Blackfrost Anivia',skinNumber: 5,price: 1820),
          Skin(skinName: 'Prehistoric Anivia',skinNumber: 6, price: 750),Skin(skinName: 'Festival Queen Anivia',skinNumber: 7,price: 975),Skin(skinName: 'Papercraft Anivia',skinNumber: 8,price: 1250)],
    ...
    Champion gnar = Champion(
        ...
        blueEssencePrice: 6300,
        rpPrice: 975,
        skins: [Skin(skinName: 'Gnar',skinNumber: 0),Skin(skinName: 'Dino Gnar',skinNumber: 1,price: 975),Skin(skinName: 'Gentleman Gnar',skinNumber: 2,price: 975),
          Skin(skinName: 'Snow Day Gnar',skinNumber: 3,price: 975),Skin(skinName: 'El León Gnar',skinNumber: 4,price: 750),Skin(skinName: 'Super Galaxy Gnar',skinNumber: 13,price: 1350),
          Skin(skinName: 'SSG Gnar',skinNumber: 14,price: 1350)],
    ...
    Champion braum = Champion(
        ...
        blueEssencePrice: 6300,
        rpPrice: 975,
        skins: [Skin(skinName: 'Braum',skinNumber: 0),Skin(skinName: 'Dragonslayer Braum',skinNumber: 1,price: 975),Skin(skinName: 'El Tigre Braum',skinNumber: 2,price: 1350),
          Skin(skinName: 'Braum Lionheart',skinNumber: 3,price: 750),Skin(skinName: 'Santa Braum',skinNumber: 10,price: 1350),Skin(skinName: 'Mafia Braum',skinNumber: 11,price: 1350),],
    ...
    Champion caitlyn = Champion(
        ...
        blueEssencePrice: 4800,
        rpPrice: 880,
        skins: [Skin(skinName: 'Caitlyn',skinNumber: 0),Skin(skinName: 'Resistance Caitlyn',skinNumber: 1,price: 520),Skin(skinName: 'Sheriff Caitlyn',skinNumber: 2,price: 520),
          Skin(skinName: 'Safari Caitlyn',skinNumber: 3,price: 975),Skin(skinName: 'Arctic Warfare Caitlyn',skinNumber: 4,price: 750),Skin(skinName: 'Officer Caitlyn',skinNumber: 5,price: 975),
          Skin(skinName: 'Headhunter Caitlyn',skinNumber: 6,price: 975),Skin(skinName: 'Lunar Wraith Caitlyn',skinNumber: 10,price: 1350),Skin(skinName: 'Pulsefire Caitlyn',skinNumber: 11,price: 1820),
          Skin(skinName: 'Pool Party Caitlyn',skinNumber: 13,price: 1350),Skin(skinName: 'Arcade Caitlyn',skinNumber: 19,price: 1350),Skin(skinName: 'Arcade Caitlyn Prestige Edition',skinNumber: 20,price: 1350)],
    ...
    Champion masterYi = Champion(
        ...
        rpPrice: 260,
        skins: [Skin(skinName: 'Master Yi',skinNumber: 0),Skin(skinName: 'Assassin Master Yi',skinNumber: 1,price: 390),Skin(skinName: 'Chosen Master Yi',skinNumber: 2,price: 520),
          Skin(skinName: 'Ionia Master Yi',skinNumber: 3,price: 975),Skin(skinName: 'Samurai Yi',skinNumber: 4,price: 520),Skin(skinName: 'Headhunter Master Yi',skinNumber: 5,price: 975),
          Skin(skinName: 'PROJECT: Yi',skinNumber: 9,price: 1820),Skin(skinName: 'Cosmic Blade Master Yi',skinNumber: 10,price: 1350),Skin(skinName: 'Eternal Sword Yi',skinNumber: 11,price: 1350),
          Skin(skinName: 'Snow Man Yi',skinNumber: 17,price: 1350)],
    ...
    Champion kayn = Champion(
        ...
        blueEssencePrice: 6300,
        rpPrice: 975,
        skins: [Skin(skinName: 'Kayn',skinNumber: 0),Skin(skinName: 'Soulhunter Kayn',skinNumber: 1,price: 1350),Skin(skinName: 'Odyssey Kayn',skinNumber: 2,price: 1820)],
    ...
    Champion zed = Champion(
        ...
        blueEssencePrice: 4800,
        rpPrice: 880,
        skins: [Skin(skinName: 'Zed',skinNumber: 0),Skin(skinName: 'Shockblade Zed',skinNumber: 1,price: 975),Skin(skinName: 'SKT T1 Zed',skinNumber: 2,price: 750),
          Skin(skinName: 'PROJECT: Zed',skinNumber: 3,price: 1350),Skin(skinName: 'Championship Zed',skinNumber: 10,price: 975),Skin(skinName: 'Death Sworn Zed',skinNumber: 11,price: 1350),
          Skin(skinName: 'Galaxy Slayer Zed',skinNumber: 13,price: 1820)],
